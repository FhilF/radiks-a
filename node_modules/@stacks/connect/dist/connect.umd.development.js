(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('blockstack'), require('jsontokens'), require('@blockstack/stacks-transactions'), require('@stacks/connect-ui'), require('@stacks/auth')) :
  typeof define === 'function' && define.amd ? define(['exports', 'blockstack', 'jsontokens', '@blockstack/stacks-transactions', '@stacks/connect-ui', '@stacks/auth'], factory) :
  (global = global || self, factory(global['@stacks/connect'] = {}, global.blockstack, global.jsontokens, global.stacksTransactions, global.connectUi, global.auth));
}(this, (function (exports, blockstack, jsontokens, stacksTransactions, connectUi, auth) { 'use strict';
