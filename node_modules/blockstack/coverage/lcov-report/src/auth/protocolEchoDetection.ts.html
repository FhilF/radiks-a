...
&nbsp;
  const searchParams = <span class="cstat-no" title="statement not covered" >new globalScope.URLSearchParams(globalScope.location.search)</span>
  const echoReplyParam = <span class="cstat-no" title="statement not covered" >searchParams.get(ECHO_REPLY_PARAM)</span>
  if (echoReplyParam) {
...
<span class="cstat-no" title="statement not covered" >    globalScope.setTimeout(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
      const authContinuationParam = <span class="cstat-no" title="statement not covered" >searchParams.get(AUTH_CONTINUATION_PARAM)</span>
