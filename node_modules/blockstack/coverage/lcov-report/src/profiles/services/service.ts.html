    ...
    return Promise.resolve()
      ...
      .then((text) =&gt; {
        ...
        if (this.shouldValidateIdentityInBody()
            &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >proof.identifier !== this.getProofIdentity(text))</span> {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  static </span>getBaseUrls(): string[] {
<span class="cstat-no" title="statement not covered" >    return []</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  static </span>getProofIdentity(searchText: string) {
