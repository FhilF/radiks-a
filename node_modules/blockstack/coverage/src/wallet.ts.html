...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import crypto, { randomBytes } from 'crypto'
...
&nbsp;
  ...
  static async fromEncryptedMnemonic(data: string, password: string) {
    try {
      const mnemonic = <span class="cstat-no" title="statement not covered" >await decryptMnemonic(data, password)</span>
      const seed = <span class="cstat-no" title="statement not covered" >await bip39.mnemonicToSeed(mnemonic)</span>
...
<span class="cstat-no" title="statement not covered" >    return bip39.generateMnemonic(128, randomBytes)</span>
  }
&nbsp;
  /**
  ...
  static async encryptMnemonic(mnemonic: string, password: string) { 
    const encryptedBuffer = <span class="cstat-no" title="statement not covered" >await encryptMnemonic(mnemonic, password)</span>
