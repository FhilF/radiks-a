	...
	<div class="row">
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				...
				<pre><code>$ npm <span class="hljs-keyword">install</span> blockstack</code></pre><h2 id="quickstart-build-an-application">Quickstart: Build an application</h2>
				<ol>
  ...
  <span class="hljs-keyword">const</span> userData = blockstack.loadUserData()
   ...
   <span class="hljs-attr">"icons"</span>: [{
     ...
     <span class="hljs-attr">"type"</span>: <span class="hljs-string">"image/png"</span>
				...
				<h2 id="add-the-library-without-a-package-manager">Add the library without a package manager</h2>
				<p>You can import <code>blockstack.js</code> as a script without using a package manager. To securely use the latest distribution of <code>blockstack.js</code> from a CDN, add the following <code>script</code> declaration in your application. </p>
				<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/blockstack@19.2.7/dist/blockstack.js"</span> <span class="hljs-attr">integrity</span>=<span class="hljs-string">"sha384-Q+bJo9xtfVPvaPa/5r/a94JoJABS5C/Y0F9gnN2NxtFUAmoQkeDdQITQ7ciLrE5C"</span> <span class="hljs-attr">crossorigin</span>=<span class="hljs-string">"anonymous"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre>
			</div>
		</div>
