...
<head>
	...
	<title>AppConfig | blockstack.js 19.2.7 Library Reference</title>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					...
					specify an app domain as the second argument.</p>
				</div>
			</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<ul class="tsd-parameters">
								...
								<li>
									<h5><span class="tsd-flag ts-flagDefault value">Default value</span> appDomain: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;getGlobalObject(&#x27;location&#x27;, { returnEmptyObject: true }).origin</span></h5>
									<div class="tsd-comment tsd-typography">
										<div class="lead">
											<p>the app domain</p>
										</div>
								...
								<li>
									...
									<div class="tsd-comment tsd-typography">
										<div class="lead">
											<p>the web-based fall back authenticator
											(<a href="../globals.html#default_blockstack_host">DEFAULT_BLOCKSTACK_HOST</a>)</p>
										</div>
									</div>
								</li>
							</ul>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class">
					...
					<h3>scopes</h3>
					<div class="tsd-signature tsd-kind-icon">scopes<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><a href="../enums/authscope.html" class="tsd-signature-type">AuthScope</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></div>
					<aside class="tsd-sources">
						<ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/blockstack/blockstack.js/blob/master/src/auth/appConfig.ts#L103">auth/appConfig.ts:103</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
				...
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/blockstack/blockstack.js/blob/master/src/auth/appConfig.ts#L95">auth/appConfig.ts:95</a></li>
								</ul>
							</aside>
							<div class="tsd-comment tsd-typography">
								<div class="lead">
