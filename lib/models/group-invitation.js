...
class GroupInvitation extends model_1.default {
    static async makeInvitation(identityAddress, userGroup) {
        const user = new user_1.default({ _id: identityAddress });
    ...
    async activate() {
        ...
        const groupMembership = new group_membership_1.default({
            ...
            identityAddress: helpers_1.loadUserData().identityAddress,
